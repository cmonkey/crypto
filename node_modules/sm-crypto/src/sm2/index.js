...
function doEncrypt(msg, publicKey, cipherMode = 1) {
    console.log("encrypt mode = " + cipherMode);
    ...
    console.log("encrypt c3 = " + c3);
    console.log("encrypt c1 c2 c3 = " + (c1 + c2 + c3));
    console.log("encrypt c1 c3 c2 = " + (c1 + c3 + c2));
...
function doDecrypt(encryptData, privateKey, cipherMode = 1) {
    console.log("decrypt mode = " + cipherMode);
    let cipher = new SM2Cipher();
    ...
    if (cipherMode === C1C2C3) {
        console.log("cic2c3 mode in decrypt");
